...
public class SetSkipListTest {
    ...
    @Test void searchingSingleItemInSkipListReturnsItem() {
        ...
        list.put(date, 1);
        assertArrayEquals(new Integer[]{1}, list.get(date).toArray(Integer.class));
    }
    ...
    @Test void searchingMultipleItemsInSkipListReturnsItems() {
        ...
        list.put(date1, 2);
        list.put(date2, 3);
        assertArrayEquals(new Integer[]{1, 2}, list.get(date).toArray(Integer.class));
        assertArrayEquals(new Integer[]{2}, list.get(date1).toArray(Integer.class));
        assertArrayEquals(new Integer[]{3}, list.get(date2).toArray(Integer.class));
    }
    ...
    @Test void removingSingleItemSingleItemSkipListAndGettingReturnsSingleItem() {
        ...
        list.put(date, 2);
        list.remove(date, 1);
        assertArrayEquals(new Integer[]{2}, list.get(date).toArray(Integer.class));
    }
